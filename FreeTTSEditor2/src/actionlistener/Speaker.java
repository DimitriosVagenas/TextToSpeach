...
public class Speaker implements TextToSpeachAPI {
	...
	//This class controls the voice of the application and works as adapter 
	
	private Voice voice;
	private VoiceManager vm;
	
	//constructor getting the kevin16 announcer
	public Speaker(){
	...
	//this method announces the text
	...
	//setters for editing the voice parameters
